...
| **Scheduled job / cron** | A task set to run at a fixed time ("every day at 21:15", "every 30 minutes"). "Cron" is the decades-old unix name for a scheduler. The fleet runs ~70 of these a day. ([the schedule](06-the-schedule.md)) |
